...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className="bg-white border-gray-200 sm:px-4 py-2.5 dark:bg-gray-900">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div
            ...
            id="mobile-menu-2"
          >
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg   md:flex-row md:space-x-14 md:mt-0 md:text-sm md:font-medium md:border-0 bg-transparent">
              <li>
                <a
                  href="#"
