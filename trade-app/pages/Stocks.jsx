  ...
  return (
    <div className="flex flex-col ">
      <div className="w-full">
        <div className="flex flex-col justify-center items-center space-y-6 bg-[#9FE2BF] p-3">
          <div>
          ...
          <div>
            <button onClick={SearchStock} class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md border border-blue-700 rounded">Search</button>
          </div>
        </div>
      </div>
